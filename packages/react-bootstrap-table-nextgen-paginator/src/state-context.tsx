...
class StateProvider extends React.Component<PaginationProviderProps> {
  ...
  setPaginationRemoteEmitter = (remoteEmitter: any) => {
    this.remoteEmitter = remoteEmitter;
  };

  getPaginationRemoteEmitter = () =>
    this.remoteEmitter || this.props.remoteEmitter;
  ...
  handleDataSizeChange(newDataSize: any) {
    const options = this.props.pagination!.options!;
    const pageStartIndex =
      typeof options.pageStartIndex === "undefined"
        ? Const.PAGE_START_INDEX
  ...
  handleChangePage(currPage: any) {
    ...
    if (this.isRemotePagination()) {
      this.getPaginationRemoteEmitter().emit(
        "paginationChange",
        currPage,
        currSizePerPage
      );
  ...
  handleChangeSizePerPage(currSizePerPage: any, currPage: any) {
    const options = this.props.pagination!.options!;
