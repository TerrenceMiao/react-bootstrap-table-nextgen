...
describe("Pagination", () => {
  ...
  describe("default pagiantion", () => {
    ...
    it("should rendering correctly", () => {
      ...
      expect(
        wrapper.dive().hasClass("react-bootstrap-table-pagination")
      ).toBeTruthy();
      expect(
        wrapper.find(".react-bootstrap-table-pagination-list-hidden").length
      ).toBe(0);
    });
  ...
  describe("when props.hidePageListOnlyOnePage is true", () => {
    ...
    it("should find react-bootstrap-table-pagination-list-hidden class when only one page", () => {
      expect(
        wrapper.dive().find(".react-bootstrap-table-pagination-list-hidden")
          .length
      ).toBe(1);
    });
  });
  ...
  describe("when props.showTotal is true", () => {
    ...
    it("should render PaginationTotal correctly", () => {
      expect(
        wrapper.find(".react-bootstrap-table-pagination-total")
      ).toHaveLength(1);
    });
